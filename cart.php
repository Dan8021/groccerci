...
<section class="shopping-cart">
   ...
   $discount = 0;
      if(isset($_POST['button1'])) {
         include ('total.php');
         $new = new App\total();
         $discount = $new -> discount($total, $grand_total);
         $grand_total = $new -> grand($discount,$grand_total);  
      }
   ?>
   </div>
   ...
   <div class="cart-total">
      ...
      <form method="post">
      <input type="submit" name="button1" class="delete-btn" style = "background-color:green"  value="Apply Coupon"/><form>
